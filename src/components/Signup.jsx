      ...
      >
        ...
        >
          ...
          <div className="space-y-1">
            ...
            />
            <div className="flex items-center justify-between"><Checkbox label={"show password"} value={showPasswordInfo} setValue={setShowPasswordInfo}></Checkbox>
            <Button type={"button"} className={"bg-gray-200 px-2 mr-2 rounded-md hover:bg-gray-400"}>i</Button></div>
